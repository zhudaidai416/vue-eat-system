<template>
    <div class="main">
        <div class="sub">
            ...
            <div class="content">
                <div><i class="el-icon-caret-right"></i> 店铺信息</div>
            ...
            <div class="content">
                <div><i class="el-icon-caret-right"></i> 法人信息</div>
                <hr style="background-color:lightgrey; height:1px; border:none;">
                <div class="content-info">
                    <div>法人姓名:</div>
                    <div>性别:</div>
            ...
            <div class="content">
                <div><i class="el-icon-caret-right"></i> 营业执照</div>
                <hr style="background-color:lightgrey; height:1px; border:none;">
                <div class="content-info">
                    <div>证件编号:</div>
                    <div>证件有效期:</div>
            ...
            <div class="content">
                <div><i class="el-icon-caret-right"></i> 经营许可证</div>
                <hr style="background-color:lightgrey; height:1px; border:none;">
                <div class="content-info">
                    <div>证件编号:</div>
                    <div>证件有效期:</div>
        ...
        <div class="sub2">
            <div class="sub2-header">审核意见</div>
            <div class="sub2-content">
                <div>当前审核人: 周审核</div>
                <div>审核结果:
                    <input type="radio" name="result" value="pass">通过
                    <input type="radio" name="result" value="deny">失败
                </div>
                <div>拒绝原因:
